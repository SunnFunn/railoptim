...
///
/// Те же окна передаются в `gu12.py --periods` ([`super::gu12`]), чтобы разрешённая
/// в ГУ-12 погрузка считалась по тем же суткам, что и спрос АПИ.
// const DEMAND_PERIODS: [(i64, i64); 4] = [(1, 5), (6, 8), (9, 10), (11, 15)];
pub const DEMAND_PERIODS: [(i64, i64); 4] = [(0, 4), (5, 7), (8, 9), (10, 14)];
