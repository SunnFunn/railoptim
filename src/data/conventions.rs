...
/// Имеют приоритет над CSV (исторически в нём было «Туркменистан,ТДЖ» — ошибка:
/// ТДЖ — Таджикская, ТРК — Туркменская; исправлено, алиасы оставлены как защита).
...
mod tests {
    ...
    fn foreign_roads_adjectives_resolve_to_short_codes() {
        ...
        // Раньше CSV говорил «Туркменистан,ТДЖ» — встроенный алиас должен побеждать в любом случае.
